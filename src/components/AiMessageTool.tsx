...
import { z } from 'zod';
import { generateMessageSuggestion } from '@/ai/flows/generate-message-suggestion-flow';
...
export function AiMessageTool() {
  ...
  return (
    <div ref={ref} className="w-full">
      <Card 
        className={cn(
          "w-full max-w-2xl mx-auto bg-card border-primary-custom shadow-xl scroll-animate-fade-in-up",
          { 'is-visible': isInView }
        )}
      >
